...
class LocalPlanner(object):
    ...
    def __init__(self, vehicle, opt_dict=None):
        ...
        self._waypoints_queue = deque(maxlen=20_000)
        self._buffer_size = 5
    ...
    def _init_controller(self, opt_dict: dict):
        ...
        self._waypoints_queue.append((self._current_waypoint.next(self._sampling_radius)[0], RoadOption.LANE_FOLLOW))

        self._target_road_option = RoadOption.LANE_FOLLOW
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            ...
            if len(next_waypoints) == 1:
                ...
                road_option = RoadOption.LANE_FOLLOW
            else:
